...
┃ ${global.prefix}tiktokstalk / user
╰━━━━━━━━━━━━━━━━━━━
...
┃ ${global.prefix}qc
┃ ${global.prefix}brat <texto>
┃ ${global.prefix}texto
╰━━━━━━━━━━━━━━━━━━━

╭━➤ 🛠️ *𝙃𝙀𝙍𝙍𝘼𝙈𝙄𝙀𝙉𝙏𝘼𝙎*
┃ ${global.prefix}ver  responder a un mensaje  
┃ ${global.prefix}tourl imagen/video
┃ ${global.prefix}whatmusic  Responder a un video
...
╰──────────────────╯`;
    ...
    await sock.sendMessage2(msg.key.remoteJid,
  {
    image: { url: "https://cdn.russellxz.click/51fe190b.jpeg" }, 
    caption: infoMessage 
  },
  msg 
);
